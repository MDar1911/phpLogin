...
<form action="md_cjdo.php" method="post" >
     <input type="hidden" name="oldxh" value="<{$cj.xh}>"/>
	学号:<input type="text"  name="xh" value="<{$cj.xh}>"/><br/>
    科目:<input type="text" name="km" value="<{$cj.km}>"/><br/>
    成绩:<input type="text" name="cj" value="<{$cj.cj}>"/><br/>
